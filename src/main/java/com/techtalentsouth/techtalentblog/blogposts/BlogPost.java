...
public class BlogPost {
	...
	//ID labels the next variable as being our 
	//primary key when stored to the database.
	@Id
    ...
    public BlogPost(String title, String author, String blogEntry) {
    	...
    	/* Effectively calls the default constructor on Java.lang.Object which we inherit from implicitly */
    	this.title = title;
    	this.author=author;
