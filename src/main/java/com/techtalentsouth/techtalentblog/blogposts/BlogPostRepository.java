...
//second parameter primary key (looked up BlogPost) first parameter what database stores
@Repository
public interface BlogPostRepository extends CrudRepository<BlogPost,Long> {
	/*What goes in here are additional methods that aren't 
	 * provided by CrudRepository that we want to perform on our database table. We don't just add methods with any name we want
	 * to do anything.......
	 * 
