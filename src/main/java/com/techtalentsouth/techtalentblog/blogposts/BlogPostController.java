...
public class BlogPostController {
	...
	public String editPostWithid(@PathVariable Long id, Model model) { //has to be the same name as above
		/* Now we are going to use the id to load the blogpost
		 * from the database table that has that id
		 */
